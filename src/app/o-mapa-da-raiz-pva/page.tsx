            ...
            <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 px-6 overflow-hidden">
                <div className="container mx-auto max-w-5xl relative z-10 text-center space-y-8">
                    <div className="inline-block px-4 py-1.5 rounded-full bg-wellness-gold text-white text-xs md:text-sm font-bold tracking-widest uppercase animate-fade-in-up">
                        VOCÊ JÁ TENTOU DE TUDO E AINDA SE PERGUNTA: O QUE HÁ DE ERRADO COMIGO?
                    </div>
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif leading-[1.1] text-slate-800 animate-fade-in-up [animation-delay:200ms]">
                        O seu <span className="italic text-wellness-sage">rosto</span> guarda a raiz do que você sente. <br />
                        E dá pra aprender a lê-la em 5 minutos.
                    </h1>
                    ...
                    <div className="animate-fade-in-up [animation-delay:600ms] flex flex-col items-center gap-6">
                        ...
                        >
                            <span className="md:hidden">QUERO DESCOBRIR A MINHA RAIZ</span>
                            <span className="hidden md:inline">QUERO DESCOBRIR A MINHA RAIZ</span>
                            <ArrowRight className="ml-3 group-hover:translate-x-1 transition-transform" />
                        </Button>

                        <p className="text-sm text-slate-500 italic">
                            Método criado pela Esp. Cleucia Venancio e Dra. Ranieli, terapeutas integrativas. A Cleucia levou 9 anos para descobrir que o corpo dela já mostrava a resposta o tempo todo.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    <div className="mt-16 w-full relative">
                        ...
                        <div className="flex gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] px-8 md:px-24 py-4 items-center">
                            {[1, 2, 3, 4].map((num) => {
                                // Cromia absoluta para Seamless Blending (Gelo, Mint pastel, Creme)
                                const specificBgs = ["bg-[#F8F9FA]", "bg-[#EBF9F1]", "bg-[#FEF9F5]", "bg-[#F8F9FA]"];
                                return (
                                    <div key={num} className="snap-center shrink-0 w-[240px] md:w-[320px] relative animate-fade-in-right group py-10">
                                        {/* Premium Hardware Frame with Outer Glow */}
                                        <div className="relative aspect-[9/19.5] bg-slate-950 rounded-[3.2rem] p-[6px] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)] group-hover:scale-[1.05] group-hover:-translate-y-4 transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)]">
                                            {/* Screen Layer with Seamless Backlight & High-End Blending */}
                                            <div className={`w-full h-full rounded-[2.8rem] overflow-hidden relative ${specificBgs[num-1]} shadow-[inset_0_0_40px_rgba(0,0,0,0.05)]`}>
                                                {/* Optimized Internal Image - Using object-cover to Fill Screen while 'Respiro' protects content */}
                                                <Image
                                                ...
                                                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-24 h-1 bg-black/10 rounded-full z-20" />
                                                
                                                {/* High-Fidelity Glass Reflection Overlay */}
                                                <div className="absolute inset-0 bg-gradient-to-tr from-white/20 via-transparent to-white/10 opacity-20 pointer-events-none group-hover:opacity-40 transition-opacity duration-700" />
                                                
                                                {/* Premium Inner Bloom (Derretimento de bordas) */}
                                                <div className="absolute inset-0 shadow-[inset_0_0_80px_rgba(255,255,255,1)] pointer-events-none z-10" />
                                                
                                                {/* Hardware Bezel Highlight */}
                                                <div className="absolute inset-0 border-[1px] border-white/10 rounded-[2.8rem] pointer-events-none z-30" />
                                            </div>

                                            {/* Hardware Side Buttons highlights */}
                                            <div className="absolute right-[-2px] top-24 w-[3px] h-12 bg-slate-800 rounded-l-sm" />
                                            <div className="absolute right-[-2px] top-40 w-[3px] h-12 bg-slate-800 rounded-l-sm" />
                                        </div>
                                    </div>
                                );
                            })}
                ...
                <div className="container mx-auto max-w-3xl">
                    ...
                    <div className="mt-20 text-center space-y-6">
                        ...
                        >
                            ...
                            <span className="hidden md:inline">SIM, QUERO DESCOBRIR A MINHA RAIZ</span>
                        </Button>
                    </div>
                </div>
            </section>
