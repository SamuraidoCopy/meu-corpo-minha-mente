...
export default function MapaPage() {
    ...
    return (
        <main className="flex flex-col lg:flex-row min-h-screen items-center justify-center py-10 px-6 lg:px-20 gap-12 relative overflow-hidden bg-gradient-to-br from-background via-background to-wellness-sage/5">
            ...
            >
                <header className="mb-12 text-center lg:text-left w-full">
                    ...
                    <p
                        className="text-foreground/70 text-lg leading-relaxed max-w-lg mx-auto lg:mx-0 animate-in fade-in slide-in-from-bottom-2 duration-700 delay-400 fill-mode-backwards"
                    >
                        Seu rosto é um mapa da sua saúde interna. Toque nas áreas que apresentam sinais para revelar a origem emocional e física.
                    </p>
                </header>

                <div className="glass rounded-[3rem] shadow-2xl p-8 lg:p-12 border-white/50 bg-white/20 backdrop-blur-md w-full max-w-lg mb-8 relative group cursor-pointer lg:hover:scale-[1.02] transition-transform duration-500 animate-in fade-in zoom-in-95 duration-1000 delay-500 fill-mode-backwards">
